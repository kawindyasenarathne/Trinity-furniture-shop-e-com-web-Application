            ...
            <div class="col">
                ...
                <div class="row  flex justify-content-center align-items-center">
                    <div class="col-5">
                        <br>
                        <div class="row">
                            <h5 class="fw-bold text-center">CREATE ACCOUNT</h5>
                        </div>
                        <hr>
                        <div class="row d-none m-3" id="msgdiv">
                        ...
                        <div class="row flex justify-content-center m-4">
                            <div class="col-4">
                                <button class="btn btn-dark regbtn" onclick="create();">Create Account</button>
                            </div>
                        </div>
